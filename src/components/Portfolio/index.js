                                ...
                                >
                                    ...
                                    <Card.Text className='col-12'>
                                        {project.tech.map((el, idx) => (
                                            <Badge
                                                variant={el.variant}
                                                key={el.variant + idx}
                                                className={`${el.bg ? `${el.bg}  p-2 mb-1 text-white textShadow boxShadow` : ` text-white p-2 mb-1 textShadow boxShadow`}`}
                                            >
                                    ...
                                    <div className='col-12 d-flex flex-wrap justify-content-center'>
                                        <Accordion.Collapse
                                            ...
                                            ref={wrapper}
                                        >
                                            <div className="mb-2 col-12 d-flex flex-wrap justify-content-center">
